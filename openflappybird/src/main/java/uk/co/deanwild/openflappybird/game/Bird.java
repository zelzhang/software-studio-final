...
public class Bird {
	...
	public float move(){
		...
		newY = Math.min(newY, MainActivity.CAMERA_HEIGHT); // don't allow through the ceiling
		newY = Math.max(newY, MainActivity.FLOOR_BOUND); // don't allow through the floor
